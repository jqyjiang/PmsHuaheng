...
<template>
  <body id="body">
    ...
    <div id="head">
      <div id="ab">
      <img src="@.\..\..\src\assets\images\ab.jpg"
      ...
      <div id="cd">
        <ul>
        <li><router-link to="/procure/pool"><img src="@.\..\..\src\assets\images\a1.jpg"
       style="width:40px ;height: 40px;margin: 0px 5px;float: left;"></router-link></li>
        <li><router-link to="/procure/requirement"><img src="@.\..\..\src\assets\images\a2.jpg"
       style="width:40px ;height: 40px;margin: 0px 5px;float: left;"></router-link></li>
       <li><router-link to="/supplierpms/details"><img src="@.\..\..\src\assets\images\a3.jpg"
       style="width:40px ;height: 40px;margin: 0px 5px;float: left;"></router-link></li>
        <li><router-link to="/pms/manager"><img src="@.\..\..\src\assets\images\a4.jpg"
       style="width:40px ;height: 40px;margin: 0px 5px;float: left;"></router-link></li>
      </ul>
      <ul>
        <li>采购需求</li>
